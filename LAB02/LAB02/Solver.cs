...
namespace LAB02
{
    ...
    public class Solver
    {
        ...
        public static string CelsiusToFahrenheit(double celsius)
        {
            ...
            return $"{celsius}C = {farenheit:F1}F";
        }
        ...
        public static string GetSeason(int month)
        {
            ...
            {
                return $"Месяц {month} - Зима";
            }
            else if (month == 3 || month == 4 || month == 5)
            {
                return $"Месяц {month} - Весна";
            }
            else if (month == 6 || month == 7 || month == 8)
            {
                return $"Месяц {month} - Лето";
            }
            else if (month == 9 || month == 10 || month == 11)
            {
                return $"Месяц {month} - Осень";
            }
            else 
            {
                return $"Месяц {month} - Не существует";
            }
        }
        ...
        public static string GetMinMaxDigit(int number)
        {
            ...
            {
                return $"Число: {number}, минимальная цифра: {number}, максимальная цифра: {number}";
            }
            int min = number % 10;
            int max = number % 10;
            ...
            return $"Число: {number}, минимальная цифра: {min}, максимальная цифра: {max}";
        }
        ...
        public static string SumOfGreaterThen(int[] array, int filter)
        {
            ...
            return $"Количество Элементов Больших {filter} = {count}";
        }
